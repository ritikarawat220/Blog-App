...
RSpec.describe User, type: :model do
  let(:user) { User.create(name: 'Ritika', photo: 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExMjk2ODdiNGFkMzE3ODQ1NDFkOTdhYWVhZWYxMDYxNjdhMWVhM2JlOCZlcD12MV9pbnRlcm5hbF9naWZzX2dpZklkJmN0PWc/BG9OrtFcxH9CjNpNcT/giphy.gif', bio: 'Hey there', posts_counter: 0) }
